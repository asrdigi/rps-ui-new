...
//    document.getElementById("btn3").onclick = changeParagraph;
    ...
    document.getElementById("btn1").addEventListener("click",changeHeading1);
    document.getElementById("btn2").addEventListener("click",changeHeading2);
    document.getElementById("btn3").addEventListener("click",changeParagraph);
}
